...
// Eager imports (not React.lazy): the site is prerendered with renderToString,
// which renders the Suspense fallback for lazy components. All page code lives
// in the main chunk; JS is deferred and TBT is ~0, so this is fine.
